...
import { create, dashboardList, findById, update, getAnalytics, importEvidence } from '../../controllers/assesment.controller';
import { createAssesment_validation, dashboardList_validation, findById_validation, updateAssesment_validation, analytics_validation, importEvidence_validation } from '../validators/assesment.validator';
