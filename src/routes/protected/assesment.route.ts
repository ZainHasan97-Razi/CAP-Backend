...
import { create, getAssignedControls, assignControls, dashboardList, findById, update, getAnalytics, getFrameworkSummaries, getByMetric, importEvidence, triggerAiAnalysis } from '../../controllers/assesment.controller';
import { createAssesment_validation, assignControls_validation, dashboardList_validation, findById_validation, updateAssesment_validation, analytics_validation, byMetric_validation, importEvidence_validation } from '../validators/assesment.validator';
